...
if ($viewCollection->renderContent) {
        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $campaign, 'columns' => array('campaign_id', 'campaign_uid', 'name', 'group_id', 'list_id', 'segment_id', 'send_at', 'started_at', 'status', 'search_ar_event', 'search_ar_time', 'search_template_name', 'gridViewSent', 'gridViewDelivered', 'gridViewOpens', 'gridViewClicks', 'gridViewBounces', 'gridViewUnsubs')), true), $itemsCount)
                        ...
                        array(
                            ...
                            'buttons'   => array(
	                            'quick-view'=> array(
		                            ...
		                            'url'       => 'Yii::app()->createUrl("campaigns/quick_view", array("campaign_uid" => $data->campaign_uid))',
		                            'imageUrl'  => null,
		                            'options'   => array('title' => Yii::t('campaigns', 'Quick view'), 'class' => 'btn btn-primary btn-flat btn-campaign-quick-view'),
	 ...
	 */
	$this->widget('common.components.web.widgets.CampaignQuickViewWidget');

	/**
	 * Since 1.9.17
	 * This creates a modal placeholder to push campaign comparison info in.
	 */
	$this->widget('common.components.web.widgets.CampaignsCompareWidget');
	?>
