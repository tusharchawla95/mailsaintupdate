...
class CampaignAbuseReport extends ActiveRecord
{
	 ...
	 * @return string
	 */
    public function getCampaignInfoWithLink()
    {
    	if (Yii::app()->apps->isAppName('customer') && !empty($this->campaign)) {
    		return CHtml::link($this->campaign_info, array(
    			'campaigns/overview', 
	 ...
	 * @return string
	 */
	public function getListInfoWithLink()
	{
		if (Yii::app()->apps->isAppName('customer') && !empty($this->list)) {
			return CHtml::link($this->list_info, array(
				'lists/overview', 
	 ...
	 * @return string
	 */
	public function getSubscriberInfoWithLink()
	{
		if (Yii::app()->apps->isAppName('customer') && !empty($this->list) && !empty($this->subscriber)) {
			return CHtml::link($this->subscriber->getDisplayEmail(), array(
