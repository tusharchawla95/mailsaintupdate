...
class CampaignDeliveryLog extends ActiveRecord
{
    ...
    {
        return array(
            self::STATUS_SUCCESS                => Yii::t('campaigns', 'Success'),
            self::STATUS_ERROR                  => Yii::t('campaigns', 'Error'),
            self::STATUS_TEMPORARY_ERROR        => Yii::t('campaigns', 'Temporary error'),
            self::STATUS_FATAL_ERROR            => Yii::t('campaigns', 'Fatal error'),
            self::STATUS_GIVEUP                 => Yii::t('campaigns', 'Giveup'),
            self::STATUS_BLACKLISTED            => Yii::t('campaigns', 'Blacklisted'),
            self::STATUS_SUPPRESSED             => Yii::t('campaigns', 'Suppressed'),
	        self::STATUS_BLOCKED                => Yii::t('campaigns', 'Blocked'),
	        self::STATUS_DOMAIN_POLICY_REJECT   => Yii::t('campaigns', 'Domain policy reject'),
        );
    }
