...
class OptionCronProcessDeliveryBounce extends FormModel
{
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
            ...
            'delivery_servers_usage_logs_removal_days' => Yii::t('settings', 'The number of days to keep the delivery server logs in the system. Please note that these logs are used for customer quota calculation so you have to keep them for at least the largest number of days used in customer sending quota.'),
        );
