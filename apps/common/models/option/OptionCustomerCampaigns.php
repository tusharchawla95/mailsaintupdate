...
class OptionCustomerCampaigns extends OptionBase
{
	...
	// 
	public $abuse_reports_email_notification = 'yes';
    ...
    {
        $rules = array(
            array('max_campaigns, send_to_multiple_lists, must_verify_sending_domain, can_delete_own_campaigns, max_bounce_rate, max_complaint_rate, can_export_stats, can_use_autoresponders, can_embed_images, can_use_timewarp, require_approval, abuse_reports_email_notification', 'required'),
            array('max_campaigns', 'numerical', 'integerOnly' => true, 'min' => -1),
            array('max_bounce_rate, max_complaint_rate', 'numerical', 'min' => -1, 'max' => 100),
            array('send_to_multiple_lists, must_verify_sending_domain, can_delete_own_campaigns, can_export_stats, can_use_autoresponders, can_embed_images, can_use_timewarp, require_approval, abuse_reports_email_notification', 'in', 'range' => array_keys($this->getYesNoOptions())),
            ...
            array('list_unsubscribe_header_email', 'email', 'validateIDN' => true),
    ...
    public function attributeLabels()
    {
        $labels = array(
	        ...
	        'abuse_reports_email_notification' => Yii::t('settings', 'Abuse reports email notification'),
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
            ...
            'abuse_reports_email_notification' => Yii::t('settings', 'When a subscriber submits an abuse report for a campaign, whether the customer should be notified via email or not.'),
        );
