...
class OptionCustomerLists extends OptionBase
{
    ...
    public $custom_fields_default_visibility = 'visible';
    ...
    public function rules()
    {
        $rules = array(
	        ...
	        array('custom_fields_default_visibility', 'in', 'range' => array_keys($this->getCustomFieldsVisibilityOptions())),
        );
    ...
    public function attributeLabels()
    {
        $labels = array(
	        ...
	        'custom_fields_default_visibility'        => Yii::t('settings', 'Custom fields default visibility'),
        );
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
            ...
            'custom_fields_default_visibility'        => Yii::t('settings', 'Decide the default visibility for the list custom fields. This affects how the fields are presented to subscribers'),
        );
	 ...
	 * @return array
	 */
    public function getCustomFieldsVisibilityOptions()
    {
	    return array(
		    ListField::VISIBILITY_VISIBLE    => Yii::t('app', 'Visible'),
		    ListField::VISIBILITY_HIDDEN     => Yii::t('app', 'Hidden'),
	    );
    }
}
