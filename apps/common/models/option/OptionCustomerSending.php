...
class OptionCustomerSending extends OptionBase
{
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
            ...
            'quota_time_value'      => Yii::t('settings', 'How many "time units" the quota is available if not consumed, set to -1 for unlimited. Please choose a value lower than the value you have set in Backend > Settings > Cron > Delivery servers logs removal days'),
