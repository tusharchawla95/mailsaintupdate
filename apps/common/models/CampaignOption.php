...
class CampaignOption extends ActiveRecord
{
	...
	public function rules()
	{
		$rules = array(
            ...
            array('max_send_count_random', 'in', 'range' => array(self::TEXT_NO, self::TEXT_YES)),
	...
	public function attributeLabels()
	{
		$labels = array(
            ...
            'share_reports_enabled'    => Yii::t('campaigns', 'Enable sharing'),
            'share_reports_password'   => Yii::t('campaigns', 'Password'),
            'share_reports_mask_email_addresses' => Yii::t('campaigns', 'Mask emails'),
    ...
    public function updateSendingGiveupCounter($by = 1)
    {
        ...
        return self::model()->updateCounters(array(
