...
class DeliveryServerMailgunWebApi extends DeliveryServer
{
    ...
    public function sendEmail(array $params = array())
    {
        ...
        try {
            ...
            Yii::log(print_r($e, true), CLogger::LEVEL_ERROR);
    ...
    protected function preCheckWebHook()
    {
        ...
        foreach (array('permanent_fail', 'temporary_fail', 'complained', 'unsubscribed') as $webhook) {
            ...
            try {
                ...
                $this->_preCheckError = Yii::t('servers', 'Cannot create the {name} webhook, reason: {reason}', array(
                    '{name}'   => $webhook,
                    '{reason}' => $e->getMessage()
                ));
            }
