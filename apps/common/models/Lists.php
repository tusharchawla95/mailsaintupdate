...
class Lists extends ActiveRecord
{
	 ...
	 */
	protected static $_subscribersCountCacheEnabled = array();
	 ...
	 * @return $this
	 */
	public function setSubscribersCountCacheEnabled($enabled = true)
	{
	 ...
	 * @return bool
	 */
	public function getSubscribersCountCacheEnabled()
	{
		return isset(self::$_subscribersCountCacheEnabled[$this->list_id]) ? 
			self::$_subscribersCountCacheEnabled[$this->list_id] : 
			true;
	}
	 ...
	 * @throws CException
	 */
	public function flushSubscribersCountCacheOnEndRequest()
	{
		$eventHandler = array($this, '_doFlushSubscribersCountCacheOnEndRequest');
		if (Yii::app()->hasEventHandler('onEndRequest')) {
			if (Yii::app()->getEventHandlers('onEndRequest')->contains($eventHandler)) {
				return;
			}
		}
		Yii::app()->attachEventHandler('onEndRequest', $eventHandler);
	}

	/**
	 * @param CEvent $event
	 */
	public function _doFlushSubscribersCountCacheOnEndRequest(CEvent $event)
	{
		try {
