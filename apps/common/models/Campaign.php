...
class Campaign extends ActiveRecord
{
	 ...
	 * @throws CException
	 */
    public function getReloadedStatus()
    {
	    $campaign = Yii::app()->getDb()->createCommand()
	        ->select('status')
	        ->from($this->tableName())
	        ->where('campaign_id = :cid', array(':cid' => (int)$this->campaign_id))
	        ->queryRow();
     ...
     * @return mixed|string
     */
    public function getSuppressionListsName()
    {
        static $suppressionNames  = array();
