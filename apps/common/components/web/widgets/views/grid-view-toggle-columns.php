...
<?php echo CHtml::beginForm($this->saveRoute, 'POST', array('class' => 'btn-group', 'id' => 'grid-view-toggle-columns'));?>
    ...
    <ul class="dropdown-menu select-columns-dropdown">
        ...
        <li class="divider"></li>
        <li><a class="text-center save-changes btn btn-primary btn-flat" href="javascript:;" onclick="$(this).closest('form').submit(); return false;"><?php echo Yii::t('app', 'Save changes');?></a></li>
    </ul>
