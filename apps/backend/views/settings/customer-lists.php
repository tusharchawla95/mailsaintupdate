                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
				            ...
				            <?php echo $form->dropDownList($model, 'custom_fields_default_visibility', $model->getCustomFieldsVisibilityOptions(), $model->getHtmlOptions('custom_fields_default_visibility')); ?>
