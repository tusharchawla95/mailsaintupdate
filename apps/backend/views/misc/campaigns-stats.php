        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->add($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $campaign, 'columns' => array('customer_id', 'name', 'bounceRate', 'hardBounceRate', 'softBounceRate', 'internalBounceRate', 'unsubscribeRate', 'complaintsRate', 'status', 'send_at')), true))
                    ->render();
                ?>
            </div>
