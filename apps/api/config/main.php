    ...
    'components' => array(
        ...
        'urlManager' => array(
            'rules' => array(
	            ...
	            // since 1.9.15
	            array('campaign_unsubscribes/index', 'pattern' => 'campaigns/<campaign_uid:([a-z0-9]+)>/unsubscribes', 'verb' => 'GET'),
	            ...
	            array('campaigns/stats', 'pattern' => 'campaigns/<campaign_uid:([a-z0-9]+)>/stats', 'verb' => 'GET'),
                ...
                array('delivery_servers/view', 'pattern' => 'delivery-servers/<server_id:(\d+)>', 'verb' => 'GET'),
            ),
        ),
